	...
	return (
		...
		c0,0.938-0.41,1.829-1.125,2.438C30.712,38.068,26.911,39.579,22.761,39.579z"
			...
			<div className="content">
				<div className="name">{comment.createdBy.name}</div>
				<div className="meta">{giveTimePassed(comment.createdAt)}</div>
...
function giveTimePassed(t){
  // time difference in millisec
  var timeDiff = new Date() - new Date(t);
