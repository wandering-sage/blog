	...
	return (
		<div className="navbar">
			...
			<div className="center">
					<Link className="link" to="/"><div className="item">HOME</div></Link>
					{user==="admin" ? (
							<Link className="link" to="/write"><div className="item">WRITE</div></Link>
					) : (	
						<div></div>
					)}
				{user ? (
						<div onClick={logUserOut} className="item">LOGOUT</div>
				) : (
					<div></div>
				)}
			</div>
			<div className="right">
				{user ? (
					...
					<>
						...
						<div className="item">
								<Link className="link" to="/register"><button className="registar">REGISTER</button></Link>
						</div>
					</>
				)}
			</div>
